            ...
            <div className="mb-4 mb-lg-5 row">
              <div className="col-4">
                <div onClick={(e) => handleJobVisibilitySelection(e, "anyone")} className="col-12 col project-type-card visibility-card p-3 rounded">
                  ...
                  <div className="d-none d-xl-block text-center project-card-text mb-3">Studios and agencies using remobay and public search engines can find this job.</div>
                </div>
              </div>
              <div className="col-4">
                <div onClick={(e) => handleJobVisibilitySelection(e, "only-upwork")} className="col-12 col project-type-card visibility-card p-3 rounded">
                  ...
                  <div className="text-center project-card-title">Only Remobay talent</div>
                  <div className="d-none d-xl-block text-center project-card-text mb-3">Only Remobay users can find this job.</div>
                </div>
              </div>
              <div className="col-4">
