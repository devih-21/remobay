                                            ...
                                            <Form className="mt-4 text-dark">
                                                <div className="form-group">
                                                    ...
                                                    <div class="input mb-4">
                                                        ...
                                                        <Input type="email" className="form-control" placeholder="Work Email Address" validations={[required, email]}/>
                                                    </div>
                                                    <div className="continue-btn my-3">
                                                        <button type="submit" className="continue-button btn btn-success btn-lg btn-block">Continue With Email</button>
                                                    </div>
                                                </div>
                                            </Form>
                                        </div>
